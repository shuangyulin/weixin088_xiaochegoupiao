...
import center from '@/views/center'
    import zuoweiguanli from '@/views/modules/zuoweiguanli/list'
    import xuesheng from '@/views/modules/xuesheng/list'
    import wodechengchexinxi from '@/views/modules/wodechengchexinxi/list'
...
const routes = [{
	...
	path: '/xuesheng',
      ...
      ,{
	path: '/wodechengchexinxi',
        name: '我的乘车信息',
        component: wodechengchexinxi
      }
      ,{
