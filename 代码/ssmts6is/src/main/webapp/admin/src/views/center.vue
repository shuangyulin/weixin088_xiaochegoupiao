  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="联系方式" prop="lianxifangshi">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='xuesheng'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
          ...
          @change="xueshengtupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    xueshengtupianUploadChange(fileUrls) {
