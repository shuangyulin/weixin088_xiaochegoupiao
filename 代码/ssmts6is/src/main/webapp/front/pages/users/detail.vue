		...
		<view class="container">
            <view class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"20rpx  20rpx 0px 0px","borderColor":"rgba(204, 153, 204, 1)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(204, 153, 204, 1)","textAlign":"left"}'>用户名：</view>
					<view class="text" :style='{"color":"rgba(0, 0, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.username}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"20rpx  20rpx 0px 0px","borderColor":"rgba(204, 153, 204, 1)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(204, 153, 204, 1)","textAlign":"left"}'>密码：</view>
					<view class="text" :style='{"color":"rgba(0, 0, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.password}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"20rpx  20rpx 0px 0px","borderColor":"rgba(204, 153, 204, 1)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(204, 153, 204, 1)","textAlign":"left"}'>角色：</view>
